...
Param(
    ...
    [string] $ResourceGroupName = 'PaaS-Containerized',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = '..\Templates\PaaS-Containerized.json',
    [string] $TemplateParametersFile = '..\Templates\PaaS-Containerized.parameters.json',
